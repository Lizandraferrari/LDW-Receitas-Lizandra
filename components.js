...
console.log("aaaaaaaaaaaaa")
    ...
    <div>
        <a href="/">
        <img src  = "public/img/cakeicon.png">
        </a>
    </div>
    <div>
...
class Footer extends HTMLElement {
  connectedCallback() {
    ...
    <div class = "devFooter">
            <a href="https://github.com/Lizandraferrari">Desenvolvido por Lizandra  <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-github" viewBox="0 0 16 16">
